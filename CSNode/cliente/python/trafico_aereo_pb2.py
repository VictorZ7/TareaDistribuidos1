...
_R_ESTADO_AVION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ip_a', full_name='trafico_aereo.r_estado_avion.ip_a', index=2,
...
_ESTADO_AVION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ip_a', full_name='trafico_aereo.estado_avion.ip_a', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REQUEST_DESTINO = _descriptor.Descriptor(
  name='Request_Destino',
  full_name='trafico_aereo.Request_Destino',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='ip_d', full_name='trafico_aereo.Request_Destino.ip_d', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_R_REQUEST_DESTINO = _descriptor.Descriptor(
  name='r_Request_Destino',
  full_name='trafico_aereo.r_Request_Destino',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='ip_d', full_name='trafico_aereo.r_Request_Destino.ip_d', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['Request_Destino'] = _REQUEST_DESTINO
DESCRIPTOR.message_types_by_name['r_Request_Destino'] = _R_REQUEST_DESTINO
...
Request_Destino = _reflection.GeneratedProtocolMessageType('Request_Destino', (_message.Message,), dict(
  DESCRIPTOR = _REQUEST_DESTINO,
  __module__ = 'trafico_aereo_pb2'
  # @@protoc_insertion_point(class_scope:trafico_aereo.Request_Destino)
  ))
_sym_db.RegisterMessage(Request_Destino)

r_Request_Destino = _reflection.GeneratedProtocolMessageType('r_Request_Destino', (_message.Message,), dict(
  DESCRIPTOR = _R_REQUEST_DESTINO,
  __module__ = 'trafico_aereo_pb2'
  # @@protoc_insertion_point(class_scope:trafico_aereo.r_Request_Destino)
  ))
_sym_db.RegisterMessage(r_Request_Destino)
...
class ServicioAereoStub(object):
  ...
  def __init__(self, channel):
    ...
    self.Dejar_air = channel.unary_unary(
        ...
        request_serializer=r_estado_avion.SerializeToString,
        response_deserializer=estado_avion.FromString,
        )
    self.Destiny = channel.unary_unary(
        '/trafico_aereo.ServicioAereo/Destiny',
        request_serializer=r_Request_Destino.SerializeToString,
        response_deserializer=Request_Destino.FromString,
        )
...
class ServicioAereoServicer(object):
  ...
  def Destiny(self, request, context):
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
    raise NotImplementedError('Method not implemented!')
...
def add_ServicioAereoServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'Dejar_air': grpc.unary_unary_rpc_method_handler(
          servicer.Dejar_air,
          request_deserializer=r_estado_avion.FromString,
          response_serializer=estado_avion.SerializeToString,
      ),
      'Destiny': grpc.unary_unary_rpc_method_handler(
          servicer.Destiny,
          request_deserializer=r_Request_Destino.FromString,
          response_serializer=Request_Destino.SerializeToString,
      ),
  }
...
class BetaServicioAereoStub(object):
  ...
  def Destiny(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
    raise NotImplementedError()
  Destiny.future = None
...
def beta_create_ServicioAereo_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
  request_deserializers = {
    ...
    ('trafico_aereo.ServicioAereo', 'Dejar_air'): r_estado_avion.FromString,
    ('trafico_aereo.ServicioAereo', 'Despegue'): Request_Despegar.FromString,
    ('trafico_aereo.ServicioAereo', 'Destiny'): r_Request_Destino.FromString,
  ...
  response_serializers = {
    ...
    ('trafico_aereo.ServicioAereo', 'Dejar_air'): estado_avion.SerializeToString,
    ('trafico_aereo.ServicioAereo', 'Despegue'): Response_Despegar.SerializeToString,
    ('trafico_aereo.ServicioAereo', 'Destiny'): Request_Destino.SerializeToString,
  ...
  method_implementations = {
    ...
    ('trafico_aereo.ServicioAereo', 'Destiny'): face_utilities.unary_unary_inline(servicer.Destiny),
...
def beta_create_ServicioAereo_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
  request_serializers = {
    ...
    ('trafico_aereo.ServicioAereo', 'Dejar_air'): r_estado_avion.SerializeToString,
    ('trafico_aereo.ServicioAereo', 'Despegue'): Request_Despegar.SerializeToString,
    ('trafico_aereo.ServicioAereo', 'Destiny'): r_Request_Destino.SerializeToString,
  ...
  response_deserializers = {
    ...
    ('trafico_aereo.ServicioAereo', 'Dejar_air'): estado_avion.FromString,
    ('trafico_aereo.ServicioAereo', 'Despegue'): Response_Despegar.FromString,
    ('trafico_aereo.ServicioAereo', 'Destiny'): Request_Destino.FromString,
  ...
  cardinalities = {
    ...
    'Destiny': cardinality.Cardinality.UNARY_UNARY,
